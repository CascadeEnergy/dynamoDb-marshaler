...
/**
 * Translates a DynamoDb formatted object (a response from DynamoDb sdk) into a plain javascript object with DynamoDb AttributeValue objects.
 *
...
module.exports = {
    ...
    marshalItem: ensureItemIsObject(marshalItem),
    unmarshalItem: ensureItemIsObject(unmarshalItem),
